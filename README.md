...
2. Clone localmente: `git clone https://github.com/rodsdev23/dio-lab-open-source.git`;
...
4. Crie uma nova **branch** e nomeie como `feat/community/rodsdev23`: `git checkout -b feat/community/rodsdev23`;
...
7. Adicione suas alterações à "staging area" com o comando `git add community/rodsdev23.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add rodsdev23 profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/rodsdev23`; 
