...
4. Crie uma nova **branch** e nomeie como `feat/community/SEUUSERNAME`: `git checkout -b feat/community/SEUUSERNAME`;
...
7. Adicione suas alterações à "staging area" com o comando `git add community/SEUUSERNAME.md`;
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil `git commit -m"feat: add SEUUSERNAME profile"`;
9. Envie as alterações para o seu repositório remoto `git push origin feat/community/SEUUSERNAME`; 
